...
inline fun <R, T> wrap(cache: MutableMap<T, Pair<Boolean, Any?>>, t: T, f: () -> R): R {
...
inline fun <T1, T2, R> memoize(crossinline f: (T1, T2) -> R): (T1, T2) -> R {
...
inline fun <T1, T2, T3, R> memoize(crossinline f: (T1, T2, T3) -> R): (T1, T2, T3) -> R {
...
inline fun <T1, T2, T3, T4, R> memoize(crossinline f: (T1, T2, T3, T4) -> R): (T1, T2, T3, T4) -> R {
...
inline fun <T1, T2, T3, T4, T5, R> memoize(crossinline f: (T1, T2, T3, T4, T5) -> R): (T1, T2, T3, T4, T5) -> R {
...
inline fun <T1, T2, T3, T4, T5, T6, R> memoize(crossinline f: (T1, T2, T3, T4, T5, T6) -> R): (T1, T2, T3, T4, T5, T6) -> R {
...
inline fun <T1, T2, T3, T4, T5, T6, T7, R> memoize(crossinline f: (T1, T2, T3, T4, T5, T6, T7) -> R): (T1, T2, T3, T4, T5, T6, T7) -> R {
...
inline fun <T1, T2, T3, T4, T5, T6, T7, T8, R> memoize(crossinline f: (T1, T2, T3, T4, T5, T6, T7, T8) -> R): (T1, T2, T3, T4, T5, T6, T7, T8) -> R {
...
inline fun <T1, T2, T3, T4, T5, T6, T7, T8, T9, R> memoize(crossinline f: (T1, T2, T3, T4, T5, T6, T7, T8, T9) -> R): (T1, T2, T3, T4, T5, T6, T7, T8, T9) -> R {
...
inline fun <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> memoize(crossinline f: (T1, T2, T3, T4, T5, T6, T7, T8, T9, T10) -> R): (T1, T2, T3, T4, T5, T6, T7, T8, T9, T10) -> R {
