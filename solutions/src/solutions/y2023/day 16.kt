...
private fun part2() {
	...
	listOf(
		inp.bounds.xs.map { it toP 0 to Clock.right },
		inp.bounds.xs.map { it toP inp.bounds.ys.last() to Clock.left },
		inp.bounds.ys.map { 0 toP it to Clock.down },
		inp.bounds.ys.map { inp.bounds.xs.last() toP it to Clock.up },
