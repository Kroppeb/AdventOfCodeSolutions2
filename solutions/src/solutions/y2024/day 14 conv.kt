...
//	var bounds = (0 toP 0) toB (Clock.down * 102 + Clock.right * 100)
	...
	var q1 = ll.filter{it.isNorthEastOf(bounds.exactCenter())} log 0
	var q2 = ll.filter{it.isNorthWestOf(bounds.exactCenter())} log 0
	var q3 = ll.filter{it.isSouthEastOf(bounds.exactCenter())} log 0
	var q4 = ll.filter{it.isSouthWestOf(bounds.exactCenter())} log 0
