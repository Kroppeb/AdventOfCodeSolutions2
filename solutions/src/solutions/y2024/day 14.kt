...
//	var bounds = (0 toP 0) toB (Clock.down * 102 + Clock.right * 100)
	...
	var q1 = ll.filter{it.isAbove(Clock.down * 51) && it.isLeftOf(Clock.right * 50)} log 0
	var q2 = ll.filter{it.isAbove(Clock.down * 51) && it.isRightOf(Clock.right * 50)} log 0
	var q3 = ll.filter{it.isBelow(Clock.down * 51) && it.isLeftOf(Clock.right * 50)} log 0
	var q4 = ll.filter{it.isBelow(Clock.down * 51) && it.isRightOf(Clock.right * 50)} log 0
